...
bash submit_schaefer400_morphology_all_sites.sh /GPFS/cuizaixu_lab_permanent/xuhaoshu/ABCD/processed/freesurfer/2YearFollowUpYArm1/SIEMENS /ibmgpfs/cuizaixu_lab/xuhaoshu/projects/sc_connectome_trajectories/data/processed/table/sublist_by_site/2YearFollowUpYArm1 ./run_schaefer400_morphology.sh
## summarize morph
