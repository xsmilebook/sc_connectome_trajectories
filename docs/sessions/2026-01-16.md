...
- 移除 sbatch 脚本时间限制，并新增 CLG-ODE continue 训练脚本与 `--resume_from` 支持。
- 调整 VectorLSTM/GNN baseline 提交脚本为 5 折数组任务，并支持按折写入 run 目录。
- 汇总 VectorLSTM 与 GNN baseline 五折结果并撰写报告。
